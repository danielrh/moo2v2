  ...
  {#if showHelp}
    <div class="help" data-testid="help-panel">
      ...
      <ul>
        ...
        <li><b>Battles</b> only happen between empires at <b>war</b> — declare it on the Empires tab. A battle is a single pass; set stance/targeting/retreat before the clash. Bombardment after a win needs <b>bomb</b>-class weapons on the fleet, and can never wipe out a colony's last population unit — land transports to invade and capture it (undefended outposts, by contrast, fall to any winning fleet).</li>
